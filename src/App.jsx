      ...
      <div ref={pdfRef} id="receipt-container" style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={styles.logoSection}>
            <img
              alt="Logo"
              src="https://app.cropsync.in/carbon.png"
              style={styles.logo}
            />
          </div>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ marginBottom: "6px" }}>
            <div style={{ ...styles.teluguText, fontSize: "14px", fontWeight: "700", color: "#e74c3c", marginBottom: "2px" }}>
        ...
        <div style={styles.footer}>
          <div style={{ fontWeight: "700", marginBottom: "2px" }}>Thank You for Using CarbonMint</div>
          <div>www.carbonmint.com | 733 090 3729</div>
        </div>
      </div>
    </>
  );
